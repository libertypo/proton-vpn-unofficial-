...
class VPNSecrets:
    ...
    def proton_fingerprint_from_x25519_pk(self):  # pylint: disable=missing-function-docstring
        return self._key_handler.get_proton_fingerprint_from_x25519_pk(self._key_handler.x25519_pk_bytes)
    ...
    def to_dict(self):  # pylint: disable=missing-function-docstring
        key_name = "ed25519" + "_privatekey"
        return {key_name: self.ed25519_privatekey}
...
class VPNPubkeyCredentials:
    ...
    def __init__(self, api_certificate: VPNCertificate, secrets: VPNSecrets, strict: bool = True):
        ...
        self._certificate_obj = self._build_certificate(api_certificate, secrets, strict)
