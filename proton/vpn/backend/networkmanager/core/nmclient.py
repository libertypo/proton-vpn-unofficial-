...
class NMClient:
    ...
    def add_connection_async(self, connection: NM.Connection, save_to_disk: bool = False) -> Future:
        ...
        :param save_to_disk: whether NetworkManager should persist the connection profile.
        :return: a Future to keep track of completion.
        """
        ...
        def add_connection_async():
            ...
            self._nm_client.add_connection_async(
                connection=connection, save_to_disk=save_to_disk, cancellable=None, callback=callback, user_data=None
            )

        self._run_on_main_loop_thread(add_connection_async)
        return future

    def start_connection_async(self, connection: NM.Connection, infer_parent_connection: bool = False) -> Future:
        ...
        def activate_connection_async():
            self._assert_running_on_main_loop_thread()
            self._nm_client.activate_connection_async(connection, None, specific_object, None, callback, None)
