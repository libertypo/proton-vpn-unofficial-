...
from proton.vpn.backend.networkmanager.killswitch.wireguard.nmclient import GatewayNotFoundError, NMClient
...
class KillSwitchConnectionHandler:
    ...
    async def add_ipv6_leak_protection(self):
        ...
        general_config = KillSwitchGeneralConfig(
            human_readable_id=connection_id, interface_name=interface_name, permanent=False
        )
