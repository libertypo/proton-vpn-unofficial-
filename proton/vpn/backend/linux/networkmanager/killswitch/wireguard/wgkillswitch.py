...
from proton.vpn.backend.linux.networkmanager.killswitch.wireguard.killswitch_connection_handler import (
...
class WGKillSwitch(KillSwitch):
    ...
    def __init__(self, ks_handler: Optional[KillSwitchConnectionHandler] = None):
