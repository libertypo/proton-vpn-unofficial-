...
class CountryRow(Gtk.Box):
    ...
    def display(
        ...
        row_data = RowViewModel(
            ...
            connect_button_tooltip=(
                f"Upgrade to connect to {country.name}" if upgrade_required else f"Connect to {country.name}"
            ),
    ...
    def _add_secure_core_row(self, expanded: bool = False):
        ...
        self._secure_core_row.display(controller, country.secure_core_group, user_tier, expanded=expanded)
    ...
    def _add_location_rows(self, expanded_locations: Optional[set[str]] = None):
        ...
        def display_location_row(location_row, location):
            ...
            location_row.display(controller, location, user_tier, expanded=location_expanded)

        sync_rows_with_model_items(
            locations, self._location_rows, self._location_row_container, LocationRow, display_location_row
        )
