...
class QuickConnectWidget(Gtk.Box):
    ...
    def __init__(self, controller: Controller):
        ...
        safe_signal_connect(self.connect_button, "clicked", self._on_connect_button_clicked)
        ...
        safe_signal_connect(self.disconnect_button, "clicked", self._on_disconnect_button_clicked)
    ...
    def connection_state(self, connection_state: states.State):
        ...
        if isinstance(connection_state, states.Disconnected) and not connection_state.context.reconnection:
    ...
    def _on_connection_state_connecting(self):
        self.connect_button.set_visible(False)
        self.disconnect_button.set_label(_("Cancel Connection"))
        self.disconnect_button.set_visible(True)

    def _on_connection_state_connected(self):
        self.connect_button.set_visible(False)
        self.disconnect_button.set_label(_("Disconnect"))
        self.disconnect_button.set_visible(True)
