...
class SettingsWindow(Gtk.Window):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(  # pylint: disable=too-many-arguments
        ...
        *,
        ...
        self._feature_settings = feature_settings or FeatureSettings(self._controller, self)
        self._connection_settings = connection_settings or ConnectionSettings(self._controller, self)
        self._general_settings = general_settings or GeneralSettings(self._controller, tray_indicator, app)
    ...
    def notify_user_with_reconnect_message(
        ...
        if (
            (is_connection_active and not self._controller.current_connection.are_feature_updates_applied_when_active)
            or (is_connection_active and only_notify_on_active_connection)
            or force_notify
        ):
