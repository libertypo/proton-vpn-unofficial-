...
class Notifications:
    ...
    def show_error_dialog(
        ...
        run_once(self._generate_and_show_dialog, title, message, hint, message_type, buttons, on_dialog_closed)
    ...
    def _generate_and_show_dialog(
        ...
        for button in buttons:
            dialog_button = Gtk.Button(label=button.label)
            self.error_dialog.add_action_widget(dialog_button, button.response_type)
    ...
    def show_error_message(self, message: str):
        ...
        GLib.idle_add(self.notification_bar.show_error_message, message)

    def show_info_message(self, message: str):
        """Shows the info message in the notification bar."""
        GLib.idle_add(self.notification_bar.show_info_message, message)

    def show_success_message(self, message: str):
        """Shows a success message in the notification bar."""
        GLib.idle_add(self.notification_bar.show_success_message, message)

    def hide_message(self):
        """Hides the revealed content."""
        GLib.idle_add(self.notification_bar.clear)

    def show_gnome_notification(self, title: str, description: str):
        """Shows a gnome desktop notification."""
        Notify.Notification.new(title, description, str(ICONS_PATH / "proton-vpn-sign.svg")).show()
