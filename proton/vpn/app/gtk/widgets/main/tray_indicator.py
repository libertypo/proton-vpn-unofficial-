...
class TrayIndicator:
    ...
    DISCONNECTED_ICON = str(ICONS_PATH / f"state-{states.Disconnected.__name__.lower()}.svg")
    ...
    def __init__(self, controller: Controller, tray_icon=None, tray_availability_detection=TrayAvailabilityDetection()):
    ...
    def _set_main_window(self, main_window: MainWindow):
        ...
        safe_signal_connect(self._main_window, "notify::visible", self._on_main_window_visibility_changed)

        safe_signal_connect(self._main_window.main_widget.login_widget, "user-logged-in", self._on_user_logged_in)
    ...
    def status_update(self, connection_status):
        ...
        logger.debug("Tray widget received connection status update: %s.", type(connection_status).__name__)
    ...
    def _setup_main_window_visibility_toggle_entry(self):
        ...
        self._tray.add_menu_item(toggle_label, self._on_toggle_app_visibility_menu_entry_clicked)
    ...
    def _on_connection_disconnected(self):
        ...
        self._tray.change_icon(self.DISCONNECTED_ICON, self.DISCONNECTED_ICON_DESCRIPTION)
