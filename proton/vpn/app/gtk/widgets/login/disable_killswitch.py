...
class DisableKillSwitchWidget(Gtk.Revealer):
    ...
    def __init__(
        ...
        safe_signal_connect(self.disable_killswitch_button, "clicked", self._on_button_click)

    def _on_button_click(self, _: Gtk.Button):
        dialog = ConfirmationDialog(DisableKillSwitchWidget.DIALOG_MESSAGE, DisableKillSwitchWidget.DIALOG_TITLE)
