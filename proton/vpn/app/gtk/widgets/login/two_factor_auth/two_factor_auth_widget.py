...
class TwoFactorAuthWidget(Gtk.Box):
    ...
    def __init__(
        ...
        self.two_factor_auth_stack = two_factor_auth_stack or TwoFactorAuthStack(
        ...
        safe_signal_connect(
            self.two_factor_auth_stack, "two-factor-auth-successful", self._on_two_factor_auth_successful
        )
        safe_signal_connect(self.two_factor_auth_stack, "two-factor-auth-cancelled", self._on_two_factor_auth_cancelled)
