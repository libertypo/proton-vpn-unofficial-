...
class AuthenticatorAppForm(Gtk.Box):  # pylint: disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        safe_signal_connect(self._code_entry, "changed", self._on_entry_changed)
        ...
        safe_signal_connect(
            self._toggle_authentication_mode_button, "clicked", self._on_toggle_authentication_mode_clicked
        )
        ...
        # on the login button.
        safe_signal_connect(self._code_entry, "activate", self._on_authenticate_button_clicked)
    ...
    def _display_2fa_ui(self):
        ...
        self.toggle_authentication_mode_button_label = self.TWOFA_TOGGLE_AUTHENICATION_MODE_LABEL
    ...
    def _display_recovery_ui(self):
        ...
        self.toggle_authentication_mode_button_label = self.RECOVERY_TOGGLE_AUTHENICATION_MODE_LABEL
    ...
    def _on_authenticate_button_clicked(self, _):
        ...
        logger.info(
            "Clicked on authenticate via authenticator app", category="UI", subcategory="LOGIN-2FA", event="CLICK"
        )
        ...
        future.add_done_callback(lambda future: GLib.idle_add(self._on_2fa_code_submission_result, future))
    ...
    def _on_2fa_code_submission_result(self, future: Future):
        ...
        if result.success:
            ...
            self._notifications.show_error_message(self.INCORRECT_TWOFA_CODE_MESSAGE)
            logger.warning(self.INCORRECT_TWOFA_CODE_MESSAGE, category="APP", subcategory="LOGIN-2FA", event="RESULT")
