...
from proton.vpn.app.gtk.i18n import initialize_i18n, should_use_rtl_layout
...
from proton.vpn.app.gtk.utils.warnings import suppress_eventlet_deprecation_warnings
...
def main():
    ...
    initialize_i18n()
    Gtk.Widget.set_default_direction(Gtk.TextDirection.RTL if should_use_rtl_layout() else Gtk.TextDirection.LTR)
