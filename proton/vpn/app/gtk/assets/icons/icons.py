...
def get(
    relative_path: Path, width: Optional[int] = None, height: Optional[int] = None, preserve_aspect_ratio: bool = True
) -> GdkPixbuf.Pixbuf:
    """
    ...
    pixbuf = GdkPixbuf.Pixbuf.new_from_file_at_scale(
        filename=filename, width=width, height=height, preserve_aspect_ratio=preserve_aspect_ratio
    )
    if pixbuf is None:
