...
class AsyncExecutor:
    ...
    def __init__(self, loop: Optional[asyncio.AbstractEventLoop] = None, executor: Optional[ThreadPoolExecutor] = None):
    ...
    def submit(
        self,
        fn: Union[Coroutine[Any, Any, Any], Callable[..., Any]],
        *args,
        **kwargs,
        ...
        if inspect.iscoroutine(fn):
            return asyncio.run_coroutine_threadsafe(fn, self._loop)
        ...
        return self._executor.submit(callable_fn, *args, **kwargs)
