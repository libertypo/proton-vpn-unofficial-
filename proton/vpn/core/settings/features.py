...
class Features:
    ...
    def from_dict(data: dict, user_tier: int) -> Features:
        ...
        split_tunneling = SplitTunneling.from_dict(split_tunneling) if split_tunneling else SplitTunneling()
    ...
    def default(user_tier: int) -> Features:  # pylint: disable=unused-argument
        ...
        return Features(
            netshield=(NetShield.NO_BLOCK.value if user_tier < 1 else NetShield.BLOCK_MALICIOUS_URL.value),
            moderate_nat=False,
