...
class ClientConfig:
    ...
    def __init__(self, openvpn_ports, wireguard_ports, holes_ips, server_refresh_interval, expiration_time):  # pylint: disable=R0913
    ...
    def from_dict(cls, apidata: dict) -> ClientConfig:
        ...
        try:
            ...
            raise ClientConfigDecodeError("Error parsing client configuration.") from error
    ...
    def load_from_cache(self) -> ClientConfig:
        ...
        if cache:
            try:
                ...
                logger.warning("Client config could not be deserialized. Using defaults.", exc_info=True)
